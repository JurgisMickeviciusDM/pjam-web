...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      {/* ---------------------------------------------------------------- */}
      {/* Investment strategies + staircase image                           */}
      {/* ---------------------------------------------------------------- */}
      <section className="bg-cream py-24 md:py-32">
        <div className="container-x grid items-center gap-12 md:grid-cols-2 md:gap-16">
          <div>
            <Reveal>
              <span className="eyebrow text-muted">01 — Overview</span>
            </Reveal>
      ...
      {/* ---------------------------------------------------------------- */}
      {/* Responsible investment + sphere "figures"                         */}
      {/* ---------------------------------------------------------------- */}
      <section className="bg-cream py-24 md:py-32">
        <div className="container-x grid items-center gap-12 md:grid-cols-2 md:gap-16">
          ...
          <div className="order-1 md:order-2">
            <Reveal>
              <span className="eyebrow text-muted">02 — Philosophy</span>
            </Reveal>
            <h2 className="mt-5 font-display text-4xl font-extrabold leading-tight tracking-tight text-ink md:text-5xl">
              <TextReveal
                lines={[
      ...
      <section className="grain relative overflow-hidden bg-noir py-24 text-cream md:py-32">
        ...
        <div className="container-x relative max-w-3xl">
          <Reveal>
            <span className="eyebrow text-gold">03 — Our Story</span>
          </Reveal>
      ...
      <section className="bg-cream py-24 md:py-32">
        <div className="container-x">
          <div className="max-w-2xl">
            <Reveal>
              <span className="eyebrow text-muted">04 — Partnership</span>
            </Reveal>
            <h2 className="mt-5 font-display text-4xl font-extrabold leading-tight tracking-tight text-ink md:text-5xl">
